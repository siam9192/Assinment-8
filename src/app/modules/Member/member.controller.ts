...
const createBook = catchAsync(async(req:Request,res:Response)=>{
    ...
    SendResponse(res,{success:true,statusCode:httpStatus.CREATED,message:'Member created successfully',data:result})
})
...
const getMemberByIdFromDB = catchAsync(async(req:Request,res:Response)=>{
    ...
    SendResponse(res,{success:true,statusCode:httpStatus.OK,message:"Member retrieved successfully",data:result})
})


const getAllMembersFromDB = catchAsync(async(req:Request,res:Response)=>{
    const result = await MemberService.getAllMembersFromDB()
    SendResponse(res,{success:true,statusCode:httpStatus.OK,message:result.length ? "Members retrieved successfully" :"No overdue Members",data:result})
})
...
const updateBookById = catchAsync(async(req:Request,res:Response)=>{
    ...
    SendResponse(res,{success:true,statusCode:httpStatus.OK,message:"Member updated successfully",data:result})
})
...
const deleteBookById = catchAsync(async(req:Request,res:Response)=>{
    ...
    SendResponse(res,{success:true,statusCode:httpStatus.OK,message:"Member deleted successfully",data:result})
})
