...
const getBookByIdFromDB = catchAsync(async(req:Request,res:Response)=>{
    ...
    SendResponse(res,{success:true,statusCode:httpStatus.OK,message:"Book retrieved successfully",data:result})
})


const getAllBooksFromDB = catchAsync(async(req:Request,res:Response)=>{
    const result = await BookService.getAllBooksFromDB()
    SendResponse(res,{success:true,statusCode:httpStatus.OK,message:result.length ? "Books retrieved successfully" :"No overdue books",data:result})
})
...
const updateBookById = catchAsync(async(req:Request,res:Response)=>{
    ...
    SendResponse(res,{success:true,statusCode:httpStatus.OK,message:"Book updated successfully",data:result})
})
...
const deleteBookById = catchAsync(async(req:Request,res:Response)=>{
    ...
    SendResponse(res,{success:true,statusCode:httpStatus.OK,message:"Book deleted successfully",data:result})
})
